  ...
  return (
    <form>
      <div className="rounded-md bg-gray-50 p-4 md:p-6">
        {/* Customer Name */}
        <div className="mb-4">
          <label htmlFor="customer" className="mb-2 block text-xs font-medium">
            Choose customer
          </label>
        ...
        {/* Invoice Amount */}
        <div className="mb-4">
          <label htmlFor="amount" className="mb-2 block text-xs font-medium">
            Choose an amount
          </label>
        ...
        {/* Invoice Status */}
        <fieldset>
          <legend className="mb-2 block text-xs font-medium">
